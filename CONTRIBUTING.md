...
Thank you for considering contributing to **@myko.pk/health** — we appreciate every bug report, documentation fix, feature suggestion, and pull request.
...
2. Clone your fork:
   ```bash
   git clone https://github.com/mykopk/health.git
   ```
...
├── health.module.ts       # Dynamic module with forRoot/forRootAsync
├── health.constants.ts    # DI token
├── health.interface.ts    # HealthCheck, HealthCheckResult types
...
Open an issue at https://github.com/mykopk/health/issues with:
